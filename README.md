...
This ToDo App is a Single Page App (SPA) that allows users to:

<ul>
  <li>Add new tasks to their todo list</li>
  <li>Mark tasks as complete</li>
  <li>Delete completed tasks</li>
</ul>

<img width="710" alt="math magicians preview" src="/react-todo-app.png">
